...
public class US6_moreTab_Aniqa {
    //1TC for login
    /**
     * 1-go to login page
     * 2-write username
    ...
    public void more_tab_options() {
        ...
        WebElement fileTab=driver.findElement(By.xpath("//span[@class='menu-popup-item-text' and text()='File']"));
        Assert.assertTrue(fileTab.isDisplayed(),"file tab is not displayed");

        //4. check if "file" is displayed
        System.out.println("fileTab.isDisplayed() = " + fileTab.isDisplayed());

        //5. locate "Appreciation" option
        WebElement appreciationTab=driver.findElement(By.xpath("//span[@class='menu-popup-item-text' and text()='Appreciation']"));
        ...
        WebElement announcementTab= driver.findElement(By.xpath("//span[@class='menu-popup-item-text' and text()='Announcement']"));
        Assert.assertTrue(announcementTab.isDisplayed(),"announcement tab is not displayed");

        //4. check if "Announcement" is displayed
        System.out.println("announcementTab.isDisplayed() = " + announcementTab.isDisplayed());

        //8. locate "Workflow" option
        WebElement workflowTab= driver.findElement(By.xpath("//span[@class='menu-popup-item-text' and text()='Workflow']"));
